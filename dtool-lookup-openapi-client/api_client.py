...
from dtool-lookup-openapi-client import rest
from dtool-lookup-openapi-client.configuration import Configuration
from dtool-lookup-openapi-client.exceptions import ApiTypeError, ApiValueError, ApiException
from dtool-lookup-openapi-client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BaseUriApi()
        api_instance.admin_base_uri_list_get  # this is an instance of the class Endpoint
        api_instance.admin_base_uri_list_get()  # this invokes api_instance.admin_base_uri_list_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.admin_base_uri_list_get.callable or self.callable in this class
